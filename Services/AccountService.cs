...
namespace BazaGljivara.Client.Services
{
    public interface IAccountService
    {
        ...
        Task<IList<User>> GetAllLocations();
    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task RegisterLocation(AddLocation model)
        {
            await _httpService.Post("/users/register", model);
        }
        ...
        public async Task<IList<User>> GetAllLocations()
        {
            return await _httpService.Get<IList<User>>("/users");
        }
